    ...
    a.fn.dropdown = function(b) {
        ...
        this.each(function() {
            ...
            function e(b) {
                ...
                var p = 0
                  , q = g.parent();
                if (!q.is("body") && q[0].scrollHeight > q[0].clientHeight && (p = q[0].scrollTop),
...
function(a) {
    ...
    a.fn.extend({
        openModal: function(c) {
            ...
            c = a.extend(g, c),
            c.dismissible && ($overlay.click(function() {
                h.closeModal(c)
            }),
...
$(window).keydown(function(e) {
    ...
    if ($('input').is(':focus') || $('.featherlight').length > 0) {} else {
        (currentView === 0) && (target = $('li.test.displayed.active'),
        sibling = '.test.displayed');
        (currentView === 1) && (target = $('li.category.displayed.active'),
        sibling = '.category.displayed');
        (currentView === 2) && (target = $('li.exception.displayed.active'),
        sibling = '.exception.displayed');
...
function _adjustSize() {
    var chartHeight = 0;
    if (currentView === 0 && $('#test-view-charts').is(':visible'))
        chartHeight = 180;
